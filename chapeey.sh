...
local text="$1"
local color="$2"
echo -e "${color}[1m"  # Set color and make bold
for (( i=0; i<${#text}; i++ )); do
echo -ne "${text:i:1}"
...
echo -e "[92m$(figlet -f small -w 80 'WELCOME TO CHAPEEY MODED STORE')[0m"  # Changed font to 'small'
typing_banner "Programmer: KONAN" "$Green"
...
ALLOWED_IPS_URL="https://raw.githubusercontent.com/duffer51/vvdip/main/Database"
if curl -s "$ALLOWED_IPS_URL" | grep -Ev '^###' | grep -q "$IP"; then
echo -e "${Green}  » Your IP is registered for installation."
else
echo -e "${ERROR}${GRAY} COULD NOT FIND ${NC} ${YELLOW}${IP}${NC} ${GRAY}IN THE DATABASE! INSTALLATION IS NT ABORTED.${NC}"
#exit 1
fi
echo ""
...
clear
REPO="https://raw.githubusercontent.com/duffer51/vvdip/main/"
start=$(date +%s)
secs_to_human() {
...
clear
echo -e " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e " [1;32mPlease Select a Domain Type Below [0m"
echo -e " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo -e " [1;32m1)[0m Use Your Own Domain (Recommended)"
echo -e " [1;32m2)[0m Use Random Domain"
echo -e " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
read -p " Please select numbers 1-2 or Any Button(Random) : " host
echo ""
if [[ $host == "1" ]]; then
echo -e " [1;32mPlease Enter Your Domain $NC"
echo -e " ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━[0m"
echo -e ""
...
echo -e "[32mloading...[0m"
clear
izinsc="https://raw.githubusercontent.com/duffer51/vvdip/main/keygen"
rm -f /usr/bin/user
...
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ","url":"https://wa.me/+254111111111"}]]}'
...
latest_version="$(curl -s https://api.github.com/repos/XTLS/Xray-core/releases | grep tag_name | sed -E 's/.*"v(.*)".*//' | head -n 1)"
...
sed -i '$ icho 1 > /proc/sys/net/ipv6/conf/all/disable_ipv6' /etc/rc.local >/dev/null 2>&1
echo -e "
$(date)"
...
wget -q https://raw.githubusercontent.com/main/ubuntu/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
...
gotop_latest="$(curl -s https://api.github.com/repos/xxxserxxx/gotop/releases | grep tag_name | sed -E 's/.*"v(.*)".*//' | head -n 1)"
