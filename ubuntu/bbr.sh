...
echo ""
echo ""
echo -e "Installing 𝐓𝐂𝐏 ��𝐁�� 𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁�� 𝐂𝐇𝐀𝐏𝐄𝐄𝐘 𝐒��𝐎��𝐄"
...
Install_BBR(){
echo -e "[32;1m================================[0m"
echo -e "[32;1mInstalling TCP BBR...[0m"
if [ -n "$(lsmod | grep bbr)" ];then
echo -e "[0;32mSuccesfully Installed TCP BBR.[0m"
echo -e "[32;1m================================[0m"
return 1
fi
echo -e "[0;32mStarting To Install BBR...[0m"
modprobe tcp_bbr
...
echo -e "[0;32mTCP BBR Install Success![0m"
else
echo -e "[1;31mFailed To Install BBR![0m"
fi
echo -e "[32;1m================================[0m"
}
Optimize_Parameters(){
echo -e "[32;1m================================[0m"
echo -e "[32;1mOptimize Parameters...[0m"
...
echo -e "[0;32mSuccesfully Optimize Parameters.[0m"
echo -e "[32;1m================================[0m"
}
Install_BBR
Optimize_Parameters
...
echo -e '[32;1m============================================================[0m'
echo -e '[0;32m                  Installation Success!                     [0m'
echo -e '[32;1m============================================================[0m'
sleep 3
